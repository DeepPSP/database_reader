...
from ..utils.utils_image import synthesis_img
...
class Hands11K(ImageDataBase):
    ...
    """
    def __init__(self, db_dir:str, mask_dir:str, hand_info_path:str, working_dir:Optional[str]=None, verbose:int=2, **kwargs:Any) -> NoReturn:
        """
        Parameters
        ----------
        db_dir: str,
