...
class LUDB(PhysioNetDataBase):
    ...
    4. rhythm distribution:
        ...
        Abnormal rhythm	                19
    5. electrical axis distribution:
        ...
        Undetermined	                10
    6. distribution of records with conduction abnomalities (totally 79):
    ...
    7. distribution of records with extrasystoles (totally 35):
    ...
    8. distribution of records with hypertrophies (totally 253):
    ...
    9. distribution of records of pacing rhythms (totally 12):
        ...
        P-synchrony	                    2
    9. distribution of records with ischemia (totally):
    ...
    10. distribution of records with non-specific repolarization abnormalities (totally 85):
        ...
        Posterior wall	                                9
        Apical	                                        11
    11. there are also 9 records with early repolarization syndrome
